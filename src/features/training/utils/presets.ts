...
export const BACKEND_DEFAULTS: Record<TrainingBackend, BackendDefaults> = {
  ...
  hf_detection: { epochs: 50, batchSize: 2, imageSize: 800, lr: 0.0001, patience: 10 },
  ...
  hf_instance: { epochs: 50, batchSize: 1, imageSize: 800, lr: 0.00005, patience: 10 },
  hf_pose: { epochs: 100, batchSize: 16, imageSize: 256, lr: 0.0005, patience: 15 },
