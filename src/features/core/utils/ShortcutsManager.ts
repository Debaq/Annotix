...
class ShortcutsManager {
  ...
  private initializeDefaultShortcuts(): void {
    const defaultShortcuts: Shortcut[] = [
      ...
      {
        id: 'audio-play-pause',
        nameKey: 'shortcuts.items.audioPlayPause.name',
        key: 'F2',
        descriptionKey: 'shortcuts.items.audioPlayPause.description',
        category: 'general',
        context: 'audio',
        enabled: true,
        editable: true,
      ...
      {
        id: 'audio-replay',
        nameKey: 'shortcuts.items.audioReplay.name',
        key: 'F3',
        descriptionKey: 'shortcuts.items.audioReplay.description',
        category: 'navigation',
        context: 'audio',
        enabled: true,
        editable: true,
      ...
      {
        id: 'audio-rewind',
        nameKey: 'shortcuts.items.audioRewind.name',
        key: 'F4',
        descriptionKey: 'shortcuts.items.audioRewind.description',
        category: 'navigation',
        context: 'audio',
        enabled: true,
        editable: true,
      ...
      {
        id: 'audio-scrub',
        nameKey: 'shortcuts.items.audioScrub.name',
        key: '← / →',
        descriptionKey: 'shortcuts.items.audioScrub.description',
        category: 'navigation',
        context: 'audio',
        enabled: true,
        editable: false,
      ...
      {
        id: 'audio-split',
        nameKey: 'shortcuts.items.audioSplit.name',
        key: 'Enter',
        descriptionKey: 'shortcuts.items.audioSplit.description',
        category: 'editing',
        context: 'audio',
        enabled: true,
        editable: false,
      ...
      {
        id: 'audio-save-next',
        nameKey: 'shortcuts.items.audioSaveNext.name',
        key: 'Tab',
        descriptionKey: 'shortcuts.items.audioSaveNext.description',
        category: 'editing',
        context: 'audio',
        enabled: true,
        editable: false,
      ...
      {
        id: 'tts-record',
        nameKey: 'shortcuts.items.ttsRecord.name',
        key: 'Space',
        descriptionKey: 'shortcuts.items.ttsRecord.description',
        category: 'general',
        context: 'tts',
        enabled: true,
        editable: true,
      ...
      {
        id: 'tts-accept',
        nameKey: 'shortcuts.items.ttsAccept.name',
        key: 'Enter',
        descriptionKey: 'shortcuts.items.ttsAccept.description',
        category: 'editing',
        context: 'tts',
        enabled: true,
        editable: true,
      ...
      {
        id: 'tts-repeat',
        nameKey: 'shortcuts.items.ttsRepeat.name',
        key: 'R',
        descriptionKey: 'shortcuts.items.ttsRepeat.description',
        category: 'editing',
        context: 'tts',
        enabled: true,
        editable: true,
      ...
      {
        id: 'tts-skip',
        nameKey: 'shortcuts.items.ttsSkip.name',
        key: 'S',
        descriptionKey: 'shortcuts.items.ttsSkip.description',
        category: 'editing',
        context: 'tts',
        enabled: true,
        editable: true,
